...
import { InfoRounded, CheckCircleRounded, WarningRounded, ErrorRounded } from '@mui/icons-material';
import { SincoTheme } from '@sinco/react';
import { PaletteOptions } from '@mui/material/styles';
import { paletteChip } from './palette';
...
const components: Components = {
    ...
    MuiChip: {
        ...
        styleOverrides: {
            colorPrimary: {
                backgroundColor: paletteChip.primary.main,
                ...
                "&.MuiButtonBase-root:hover": {
                    backgroundColor: paletteChip.primary.dark
                }
